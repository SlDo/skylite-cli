...
log(boxen_1.default("\n  " + chalk_1.default.hex('#a7c5eb').bold('WELCOME!') + "                                   \n  " + chalk_1.default.whiteBright('snCLI can help you to create a powerful Node.js application') + "\n", { padding: 1, borderColor: '#a7c5eb' }));
exports.config = new config_1.Config(os_1.default.homedir() + "/.sncli/config.json");
